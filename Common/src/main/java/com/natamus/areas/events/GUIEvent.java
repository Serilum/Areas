...
public class GUIEvent {
	...
	public static void renderOverlay(GuiGraphics guiGraphics, float tickDelta) {
		if (!hudmessage.equals("")) {
			...
			double stringWidth = font.width(hudmessage);
			...
			guiGraphics.drawString(font, hudmessage, (int)(Math.round((width / 2F) / modifier) - stringWidth/2), ConfigHandler.HUDMessageHeightOffset, colour.getRGB());
